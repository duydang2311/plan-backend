...
public static partial class DtoMapper
{
    ...
    public static partial ICollection<BaseChatMemberDto>? ChatMembersToDtoInternal(ICollection<ChatMember>? chatMembers);
    ...
    public static BaseChatMemberDto? ChatMemberToDto(ChatMember chatMember) =>
        ChatMemberToDtoInternal(chatMember);
}
