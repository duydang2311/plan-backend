...
namespace WebApp.Host.Migrations
{
    ...
    [Migration("20240815204425_022_team-invitations")]
    partial class _022_teaminvitations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.TeamInvitation", b =>
                {
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_team_invitations_user_id");
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.TeamInvitation", b =>
                {
                    ...
                    b.HasOne("WebApp.Domain.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_team_invitations_users_user_id");

                    b.HasOne("WebApp.Domain.Entities.TeamMember", null)
                        .WithOne("PendingInvitation")
                        .HasForeignKey("WebApp.Domain.Entities.TeamInvitation", "TeamId", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_team_invitations_team_members_team_id_user_id");
