...
namespace WebApp.Host.Migrations
{
    ...
    [Migration("20250619012700_111_notifications_issue-status-updated-trigger")]
    partial class _111_notifications_issuestatusupdatedtrigger
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.Issue", b =>
                {
                    ...
                    b.Property<NpgsqlTsVector>("SearchVector")
                        ...
                        .HasComputedColumnSql("to_tsvector('simple_unaccented', \"title\" || ' ' || regexp_replace(coalesce(\"description\", ''), '<[^>]*>', ' ', 'g'))", true);
                    ...
                    b.HasIndex("SearchVector")
                        .HasDatabaseName("ix_issues_search_vector");
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.Milestone", b =>
                {
                    ...
                    b.HasIndex("StatusId")
                        .HasDatabaseName("ix_milestones_status_id");

                    b.ToTable("milestones", (string)null);
                });

            modelBuilder.Entity("WebApp.Domain.Entities.MilestoneStatus", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_milestone_statuses");

                    b.HasIndex("ProjectId")
                        .HasDatabaseName("ix_milestone_statuses_project_id");

                    b.HasIndex("Rank")
                        .HasDatabaseName("ix_milestone_statuses_rank");

                    b.ToTable("milestone_statuses", (string)null);
                });
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.Project", b =>
                {
                    ...
                    b.Property<NpgsqlTsVector>("SearchVector")
                        ...
                        .HasColumnType("tsvector")
                        .HasColumnName("search_vector")
                        .HasAnnotation("Npgsql:TsVectorConfig", "simple_unaccented")
                        .HasAnnotation("Npgsql:TsVectorProperties", new[] { "Name", "Identifier", "Description" });
                    ...
                    b.HasIndex("SearchVector")
                        .HasDatabaseName("ix_projects_search_vector");
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.MilestoneStatus", b =>
                {
                    b.HasOne("WebApp.Domain.Entities.Project", "Project")
                        .WithMany("MilestoneStatuses")
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_milestone_statuses_projects_project_id");
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.Project", b =>
                {
                    ...
                    b.Navigation("MilestoneStatuses");
