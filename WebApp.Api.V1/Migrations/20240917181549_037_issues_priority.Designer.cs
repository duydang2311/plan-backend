...
namespace WebApp.Host.Migrations
{
    ...
    [Migration("20240917181549_037_issues_priority")]
    partial class _037_issues_priority
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.ProjectIssue", b =>
                {
                    ...
                    b.HasKey("ProjectId", "IssueId")
                        .HasName("pk_project_issues");

                    b.HasIndex("IssueId")
                        .HasDatabaseName("ix_project_issues_issue_id");

                    b.ToTable("project_issues", (string)null);
                });
            ...
            modelBuilder.Entity("project_statuses", b =>
                {
                    ...
                    b.HasIndex("ProjectId")
                        .HasDatabaseName("ix_project_statuses_project_id");
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.WorkspaceMember", b =>
                {
                    ...
                    b.HasIndex("WorkspaceId")
                        .HasDatabaseName("ix_user_roles_workspace_id");

                    b.HasDiscriminator().HasValue("workspace");
                });
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.ProjectIssue", b =>
                {
                    b.HasOne("WebApp.Domain.Entities.Issue", "Issue")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_project_issues_issues_issue_id");
                    ...
                    b.HasOne("WebApp.Domain.Entities.Project", "Project")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_project_issues_projects_project_id");
            ...
            modelBuilder.Entity("project_statuses", b =>
                {
                    b.HasOne("WebApp.Domain.Entities.Project", "Project")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_project_statuses_projects_project_id");
                    ...
                    b.HasOne("WebApp.Domain.Entities.Status", "Status")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_project_statuses_statuses_status_id");
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.WorkspaceMember", b =>
                {
                    b.HasOne("WebApp.Domain.Entities.Workspace", "Workspace")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_roles_workspaces_workspace_id");
