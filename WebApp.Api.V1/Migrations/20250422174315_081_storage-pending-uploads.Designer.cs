...
namespace WebApp.Host.Migrations
{
    ...
    [Migration("20250422174315_081_storage-pending-uploads")]
    partial class _081_storagependinguploads
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.WorkspaceResource", b =>
                {
                    ...
                    b.HasIndex("WorkspaceId1")
                        .HasDatabaseName("ix_workspace_resources_workspace_id1");
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.DocumentResource", b =>
                {
                    b.HasBaseType("WebApp.Domain.Entities.Resource");
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.FileResource", b =>
                {
                    b.HasBaseType("WebApp.Domain.Entities.Resource");
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.WorkspaceResource", b =>
                {
                    ...
                    b.HasOne("WebApp.Domain.Entities.Workspace", "Workspace")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_workspace_resources_workspaces_workspace_id1");
