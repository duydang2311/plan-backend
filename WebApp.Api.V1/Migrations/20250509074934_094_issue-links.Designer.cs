...
namespace WebApp.Host.Migrations
{
    ...
    [Migration("20250509074934_094_issue-links")]
    partial class _094_issuelinks
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.IssueTimeline", b =>
                {
                    ...
                    b.HasKey("IssueId")
                        .HasName("pk_issue_timelines");

                    b.ToTable("issue_timelines", (string)null);
                });
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.IssueTimeline", b =>
                {
                    b.HasOne("WebApp.Domain.Entities.Issue", "Issue")
                        .WithOne("Timeline")
                        .HasForeignKey("WebApp.Domain.Entities.IssueTimeline", "IssueId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_issue_timelines_issues_issue_id");
