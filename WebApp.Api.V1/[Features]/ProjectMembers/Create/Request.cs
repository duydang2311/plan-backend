...
using WebApp.Features.ProjectMembers.Create;
...
{
    [MapProperty(nameof(Request.Role), nameof(CreateProjectMember.RoleId))]
    public static partial CreateProjectMember ToCommand(this Request request);
